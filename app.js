...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className ='task__input task__input--checkbox';
    ...
    editInput.type="text";
    editInput.className="task__input task__input--text";

    editButton.innerText="Edit"; //innerText encodes special characters, HTML does not.
    editButton.className="task__button--edit task__button";

    deleteButton.className="task__button--delete task__button";
